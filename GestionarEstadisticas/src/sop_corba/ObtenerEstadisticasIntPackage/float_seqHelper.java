...
/**
* sop_corba/ObtenerEstadisticasIntPackage/float_seqHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from operaciones.idl
* lunes 3 de julio de 2023 08:15:15 AM COT
*/

abstract public class float_seqHelper
{
  private static String  _id = "IDL:sop_corba/ObtenerEstadisticasInt/float_seq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (sop_corba.ObtenerEstadisticasIntPackage.float_seqHelper.id (), "float_seq", __typeCode);
    }
    return __typeCode;
  }
